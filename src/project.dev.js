window.__require = function e(t, n, r) {
  ...
  GameMode: [ function(require, module, exports) {
    ...
    cc.Class(_defineProperty({
      ...
      OnFinishLoading: function OnFinishLoading() {
        ...
        this.node.emit("OnFinishLoading");
      },
      start: function start() {
      ...
      GetPrizeData: function GetPrizeData() {
        var self = this;
        var url = "".concat(this.BaseUrl, "Player/GetPrizes");
        var xhr = new XMLHttpRequest();
        xhr.onreadystatechange = function() {
          if (4 == xhr.readyState && xhr.status >= 200 && xhr.status < 400) {
            var response = xhr.responseText;
            var JSONResponse = JSON.parse(response);
            cc.log("Finish Getting Player Prizes ".concat(response));
            self.AvailablePrizes = JSONResponse;
            cc.log(self.AvailablePrizes);
          }
        };
        xhr.onerror = function() {
          alert("ERROR : Can't get prize data please refresh the page in few minutes time.");
        };
      ...
      GetPlayerUserId: function GetPlayerUserId() {
        ...
        xhr.onreadystatechange = function() {
          if (4 == xhr.readyState && xhr.status >= 200 && xhr.status < 400) {
            ...
            PState.PlayerId = JSONResponse.user_id;
  ...
  LevelLabel: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      onLoad: function onLoad() {
        ...
        this.labelComponent || (this.labelComponent = this.getComponent(cc.Label));
      },
      FindDeep: function FindDeep(node, nodeName) {
        if (node.name == nodeName) return node;
        for (var i = 0; i < node.children.length; i++) {
      ...
      start: function start() {
        ...
        if (this.levelType == LevelType.Start) {
          var LevelName = this.SceneName.replace(RegularExp, "$& ");
          this.labelComponent.string = LevelName;
          return;
        }
        this.labelComponent.string = this.m_GameMode.CurrentLevel;
      }
    });
    cc._RF.pop();
  }, {} ],
  LoadingScript: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "96bfeJXrTVKRrr9QF9ZrvYE", "LoadingScript");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {},
  ...
  PrizesLabel: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "02de1BEUlZM76koxGnwkA39", "PrizesLabel");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
      ...
      onLoad: function onLoad() {
        this.m_GameMode = this.FindDeep(cc.director.getScene(), "Canvas").getComponent("GameMode");
        this.LabelComp || (this.LabelComp = this.getComponent(cc.Label));
      },
      FindDeep: function FindDeep(node, nodeName) {
        if (node.name == nodeName) return node;
        for (var i = 0; i < node.children.length; i++) {
      ...
      start: function start() {
        var CurrentLevel = this.m_GameMode.CurrentLevel;
        var bLevelExist = false;
        var CashPrize = 0;
        for (var it = 0; it < this.m_GameMode.AvailablePrizes.length; it++) {
          bLevelExist |= this.m_GameMode.AvailablePrizes[it].gameLevel == CurrentLevel;
          if (!bLevelExist) continue;
          CashPrize = this.m_GameMode.AvailablePrizes[it].prize;
          CashPrize = CashPrize.trim();
          cc.log("This Level Prize : ".concat(CashPrize));
          break;
        }
        this.LabelComp.string = CashPrize;
      }
    });
    cc._RF.pop();
  }, {} ],
  ...
  UIHelper: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      onLoad: function onLoad() {
        ...
        this.m_GameMode.node.on("OnFinishLoading", this.DisableLoadingScreen, this);
      },
      DisableLoadingScreen: function DisableLoadingScreen() {
      ...
      start: function start() {
        ...
        if (this.LoadingScreen) {
          var AnimComp = this.LoadingScreen.getChildByName("Root").getComponent(cc.Animation);
          AnimComp.play();
        }
      },
      update: function update(dt) {},
...
}, {}, [ "ParallaxBG", "Collectibles", "Goal", "MovingPlatform", "Obstacle", "SpeedUpPlatform", "Buff", "CameraControl", "HeroController", "PlayerState", "TouchHandler", "GameMode", "Global", "CoinMinusLabel", "LevelLabel", "LoadingScript", "NextLevelButton", "PrizesLabel", "UIHelper" ]);